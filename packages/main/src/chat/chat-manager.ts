...
import { convertToModelMessages, generateText, isStepCount, isTextUIPart, streamText, toUIMessageStream } from 'ai';
...
import { FileContentDetector } from '../plugin/inference/file-content-detector.js';
